...
const REQUIRED_OPERATIONS: ContractRequirement[] = [
  ...
  { path: '/api/health/openclaw', method: 'get', statuses: ['200', '503'] },
  ...
  { path: '/api/openclaw/connect/register', method: 'post', statuses: ['201', '400', '401', '500'] },
  { path: '/api/openclaw/connect/jobs/claim', method: 'post', statuses: ['200', '204', '401', '500'] },
  { path: '/api/openclaw/connect/heartbeat', method: 'post', statuses: ['200', '401', '500'] },
  { path: '/api/openclaw/connect/work-items/{id}/question', method: 'post', statuses: ['200', '400', '401', '404', '409', '500'] },
  { path: '/api/openclaw/connect/work-items/{id}/pr', method: 'post', statuses: ['200', '400', '401', '404', '409', '500'] },
  ...
  { path: '/api/admin/openclaw/dds-agent', method: 'get', statuses: ['200', '500'] },
  { path: '/api/admin/openclaw/bootstrap-token', method: 'post', statuses: ['201', '400', '500'] },
  { path: '/api/admin/openclaw/control-token/rotate', method: 'post', statuses: ['200', '500'] },
  { path: '/api/admin/bulk-actions/execute', method: 'post', statuses: ['200', '400', '500'] },
  ...
  { path: '/api/admin/log-center/insights', method: 'get', statuses: ['200', '400'] },
  { path: '/api/admin/log-center/export', method: 'get', statuses: ['200', '400'] },
  { path: '/api/admin/log-center/openclaw', method: 'post', statuses: ['200', '400', '404'] },
  ...
  { path: '/api/internal/openclaw-retries/run', method: 'get', statuses: ['200', '401', '500', '503'] },
  { path: '/api/internal/openclaw-retries/run', method: 'post', statuses: ['200', '401', '500', '503'] },
