...
CREATE INDEX "idx_dead_stock_drug_master_package_id" ON "dead_stock_items" USING btree ("drug_master_package_id");--> statement-breakpoint
CREATE INDEX "idx_drug_packages_normalized_label" ON "drug_master_packages" USING btree ("normalized_package_label");--> statement-breakpoint
CREATE INDEX "idx_used_med_drug_master_package_id" ON "used_medication_items" USING btree ("drug_master_package_id");