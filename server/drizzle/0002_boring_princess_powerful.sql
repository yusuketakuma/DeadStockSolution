...
CREATE INDEX "idx_relationships_pharmacy" ON "pharmacy_relationships" USING btree ("pharmacy_id","relationship_type");--> statement-breakpoint
CREATE UNIQUE INDEX "idx_relationships_unique" ON "pharmacy_relationships" USING btree ("pharmacy_id","target_pharmacy_id");