...
- `PREFLIGHT.md`: repository-side preflight checklist and runtime/layout notes.
...
The actual runtime/auth files also live under `~/.openclaw/agents/dss-manager/`; this repo folder is
the contract and runbook side, not the executable side.
