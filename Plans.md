...
### v0.0.22 リリース前品質強化 (2026-03-28) — 完了 (2026-03-28)

> 14タスク — 3Phase構成、多角的レビュー結果ベース

#### Phase 1: テスト・安全性 (P0) — 4タスク

- [x] T1140: Stripe webhook + subscriptions ルートテスト追加 `cc:完了`
- [x] T1141: proposal-templates ルートテスト追加 `cc:完了`
- [x] T1142: push 通知 preference バリデーション確認・補強 `cc:完了`
- [x] T1143: E2E proposal flow CI 安定性検証 `cc:完了`

#### Phase 2: UX・アクセシビリティ (P1) — 5タスク

- [x] T1144: NotificationsPage ローディング状態改善 `cc:完了`
- [x] T1145: MessagesPage スレッド一覧スケルトン追加 `cc:完了`
- [x] T1146: アイコンボタン aria-label 追加 `cc:完了`
- [x] T1147: 期限切迫表示のアクセシビリティ補強 `cc:完了`
- [x] T1148: Cron ジョブ実行メトリクスログ統一 `cc:完了`

#### Phase 3: 保守性・運用ドキュメント (P2) — 5タスク

- [x] T1149: MatchingPage コンポーネント分割 `cc:完了` depends:T1146
- [x] T1150: チャートコンポーネント遅延ロード `cc:完了`
- [x] T1151: Dependabot 設定追加 `cc:完了`
- [x] T1152: シークレットローテーション手順書 `cc:完了`
- [x] T1153: マイグレーションロールバック手順書 `cc:完了`
