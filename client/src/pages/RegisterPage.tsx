        ...
        <Card.Body>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="password" value={form.password} onChange={handleChange('password')} required minLength={8} />
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" value={form.licenseNumber} onChange={handleChange('licenseNumber')} required />
            </Form.Group>
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Select value={form.prefecture} onChange={handleChange('prefecture')} required>
              ...
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="text" value={form.postalCode} onChange={handleChange('postalCode')} placeholder="1234567" required />
                </Form.Group>
              </Col>
            </Row>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" value={form.address} onChange={handleChange('address')} required />
            </Form.Group>
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="tel" value={form.phone} onChange={handleChange('phone')} required />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group className="mb-3">
                  <Form.Label>FAX番号 <span className="text-danger">*</span></Form.Label>
                  <Form.Control type="tel" value={form.fax} onChange={handleChange('fax')} required />
                </Form.Group>
              </Col>
            </Row>
