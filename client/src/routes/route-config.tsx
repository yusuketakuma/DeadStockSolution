...
const UploadQualityPage = lazy(() => import('../pages/UploadQualityPage'));
...
const AdminMatchingExperimentsPage = lazy(() => import('../pages/admin/AdminMatchingExperimentsPage'));
const AdminUploadQualityPage = lazy(() => import('../pages/admin/AdminUploadQualityPage'));
const AdminErrorCodesPage = lazy(() => import('../pages/admin/AdminErrorCodesPage'));
...
export const ROUTE_META: readonly RouteMeta[] = Object.freeze([
  ...
  { path: '/upload-quality', access: 'protected', userOnly: true, useLayout: true, component: UploadQualityPage, title: 'アップロード品質', parent: '/upload' },
  ...
  { path: '/exchange-history', access: 'protected', userOnly: true, useLayout: true, component: ExchangeHistoryPage, title: '交換履歴', parent: '/proposals' },
  ...
  { path: '/admin/pharmacy-health', access: 'protected', adminOnly: true, useLayout: true, component: AdminPharmacyHealthPage, title: '薬局ヘルス', parent: '/admin/pharmacies' },
  ...
  { path: '/admin/matching-experiments', access: 'protected', adminOnly: true, useLayout: true, component: AdminMatchingExperimentsPage, title: 'マッチング実験', parent: '/admin' },
  ...
  { path: '/admin/error-codes', access: 'protected', adminOnly: true, useLayout: true, component: AdminErrorCodesPage, title: 'エラーコード', parent: '/admin/log-center' },
  { path: '/admin/audit', access: 'protected', adminOnly: true, useLayout: true, component: AdminAuditPage, title: '監査ログ', parent: '/admin' },
  { path: '/admin/business-hours', access: 'protected', adminOnly: true, useLayout: true, component: AdminBusinessHoursPage, title: '営業時間', parent: '/admin/pharmacies' },
  { path: '/admin/bulk-actions', access: 'protected', adminOnly: true, useLayout: true, component: AdminBulkActionsPage, title: '一括操作', parent: '/admin/pharmacies' },
  { path: '/admin/relationships', access: 'protected', adminOnly: true, useLayout: true, component: AdminRelationshipsPage, title: '関係性監査', parent: '/admin/pharmacies' },
  ...
  { path: '/admin/logs', access: 'protected', adminOnly: true, useLayout: true, component: AdminLogsPage, title: '操作ログ', parent: '/admin/log-center' },
  { path: '/admin/rate-limits', access: 'protected', adminOnly: true, useLayout: true, component: AdminRateLimitsPage, title: 'レート制限設定', parent: '/admin/log-center' },
]);
