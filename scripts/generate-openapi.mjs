...
const ROUTE_BASELINE = [
  ...
  {
    path: '/api/openclaw/connect/register',
    method: 'post',
    operationId: 'registerOpenClawDdsAgent',
    summary: 'Register DDS agent with bootstrap token',
    tags: ['OpenClaw'],
    responses: [
      { status: '201', description: 'DDS agent registered', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '400', description: 'Invalid DDS registration payload', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '401', description: 'Invalid bootstrap token', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'DDS registration failed', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/openclaw/connect/jobs/claim',
    method: 'post',
    operationId: 'claimOpenClawDdsJob',
    summary: 'Claim next DDS work item',
    tags: ['OpenClaw'],
    responses: [
      { status: '200', description: 'DDS job response', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '204', description: 'No DDS job available', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '401', description: 'DDS control token invalid', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'DDS job claim failed', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/openclaw/connect/heartbeat',
    method: 'post',
    operationId: 'heartbeatOpenClawDdsAgent',
    summary: 'Record DDS agent heartbeat',
    tags: ['OpenClaw'],
    responses: [
      { status: '200', description: 'DDS heartbeat response', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '401', description: 'DDS control token invalid', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'DDS heartbeat failed', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/openclaw/connect/work-items/{id}/question',
    method: 'post',
    operationId: 'postOpenClawDdsQuestion',
    summary: 'Post DDS question for a work item',
    tags: ['OpenClaw'],
    responses: [
      { status: '200', description: 'DDS question accepted', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '400', description: 'Invalid DDS question payload', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '401', description: 'DDS control token invalid', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '404', description: 'DDS work item not found', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '409', description: 'DDS lease token invalid', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'DDS question failed', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/openclaw/connect/work-items/{id}/pr',
    method: 'post',
    operationId: 'reportOpenClawDdsPullRequest',
    summary: 'Report DDS pull request for a work item',
    tags: ['OpenClaw'],
    responses: [
      { status: '200', description: 'DDS pull request accepted', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '400', description: 'Invalid DDS pull request payload', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '401', description: 'DDS control token invalid', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '404', description: 'DDS work item not found', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '409', description: 'DDS lease token invalid', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'DDS pull request report failed', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/pharmacies',
  ...
  {
    path: '/api/admin/openclaw/dds-agent',
    method: 'get',
    operationId: 'getAdminOpenClawDdsAgentStatus',
    summary: 'Get DDS agent connection status',
    tags: ['Admin'],
    responses: [
      { status: '200', description: 'DDS agent status response', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'DDS agent status fetch failed', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/admin/openclaw/bootstrap-token',
    method: 'post',
    operationId: 'issueAdminOpenClawBootstrapToken',
    summary: 'Issue DDS bootstrap token',
    tags: ['Admin'],
    responses: [
      { status: '201', description: 'DDS bootstrap token issued', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '400', description: 'Invalid bootstrap token request', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'DDS bootstrap token issue failed', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/admin/openclaw/control-token/rotate',
    method: 'post',
    operationId: 'rotateAdminOpenClawControlToken',
    summary: 'Rotate DDS control token',
    tags: ['Admin'],
    responses: [
      { status: '200', description: 'DDS control token rotated', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'DDS control token rotation failed', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/admin/bulk-actions/execute',
    method: 'post',
    operationId: 'executeAdminBulkAction',
    summary: 'Execute admin bulk action',
    tags: ['Admin'],
    responses: [
      { status: '200', description: 'Admin bulk action executed', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '400', description: 'Invalid admin bulk action payload', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'Admin bulk action failed', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/admin/logs',
  ...
  {
    path: '/api/internal/openclaw-retries/run',
    method: 'get',
    operationId: 'runInternalOpenClawRetries',
    summary: 'Run internal OpenClaw retry jobs',
    tags: ['Internal'],
    responses: [
      { status: '200', description: 'Internal OpenClaw retry response', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '401', description: 'Internal OpenClaw retry unauthorized', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '500', description: 'Internal OpenClaw retry failed', schemaRef: '#/components/schemas/GenericResponse' },
      { status: '503', description: 'Internal OpenClaw retry not configured', schemaRef: '#/components/schemas/GenericResponse' },
    ],
  },
  {
    path: '/api/internal/openclaw-retries/run',
    method: 'post',
    operationId: 'runInternalOpenClawRetriesPost',
    summary: 'Run internal OpenClaw retry jobs',
    tags: ['Internal'],
    responses: [
      { status: '200', description: 'Internal OpenClaw retry response', schemaRef: '#/components/schemas/GenericResponse' },
